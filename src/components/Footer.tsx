        ...
        <div className="py-16 grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1 animate-fade-in-up">
            ...
            <p className="text-gray-300 leading-relaxed hover:text-white transition-colors duration-300">
              Simplifying technology, amplifying growth. We bridge the gap
          ...
          <div className="animate-fade-in-up" style={{ animationDelay: "200ms" }}>
            ...
            <ul className="space-y-3">
              <li className="text-gray-300 hover:text-white hover:translate-x-2 transition-all duration-300 cursor-default inline-flex items-center gap-2 group">
        ...
        <div className="border-t border-white/20 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-300 text-sm font-medium">
              © {new Date().getFullYear()} <span className="text-white font-bold">SoftTechniques</span>. Crafted with care.
            </p>
